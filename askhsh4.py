...
#Prospathisa na kanw elegxw an o arithmos einai integer alla den doulevei den kserw giati omws
while True:
	print("Please insert the number that you would like to romanize\n")
	num = int(input())
	check = isinstance(num, int)
	if check == False:
		print('Please olny insert integers')
		continue
